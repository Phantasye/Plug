...
import server.world.item.GameItem;
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        switch (actionButtonId) {
            ...
            case 25120:
                ...
                Player o1 = Server.playerHandler.players[c.duelingWith];
                if (o1 == null) {
                    c.getTradeAndDuel().declineDuel();
                    return;
                }
            ...
            case 13092:
                ...
                Player ot = Server.playerHandler.players[c.tradeWith];
                if (ot == null) {
            ...
            case 13218:
                ...
                Player ot1 = Server.playerHandler.players[c.tradeWith];
                if (ot1 == null) {
                    c.getTradeAndDuel().declineTrade();
                    c.sendMessage("Trade declined as the other player has disconnected.");
                    break;
            ...
            case 47130:
                c.forcedChat = "I must slay another " + c.taskAmount + " " + Server.npcHandler.getNpcListName(c.slayerTask) + ".";
