                ...
                CycleEventHandler.getSingleton().addEvent(new CycleEvent(Player.WALKING_TO_ACTIONS_KEY, 1) {
                    ...
                    public void execute() {
                        ...
                        if (c.goodDistance(Server.npcHandler.npcs[c.npcClickIndex].getX(), Server.npcHandler.npcs[c.npcClickIndex].getY(), c.getX(), c.getY(), 1)) {
                            c.facePosition(Server.npcHandler.npcs[c.npcClickIndex].getX(), Server.npcHandler.npcs[c.npcClickIndex].getY());
                            Server.npcHandler.npcs[c.npcClickIndex].facePlayer(c.slot);
