package server.core.net.protocol;
...
import server.world.entity.player.PlayerSave;
...
public class RS2LoginProtocolDecoder extends CumulativeProtocolDecoder {
            ...
            switch (loginStage) {
                ...
                case 1:
                    ...
                    if (loginPacketSize <= in.remaining()) {
                        ...
                        ISAACCipher inC = new ISAACCipher(sessionKey);
                        for (int i = 0; i < 4; i++)
                            sessionKey[i] += 50;
                        ISAACCipher outC = new ISAACCipher(sessionKey);
    ...
    private synchronized void load(final IoSession session, final int uid, String name, String pass, final ISAACCipher inC, ISAACCipher outC, int version) {
