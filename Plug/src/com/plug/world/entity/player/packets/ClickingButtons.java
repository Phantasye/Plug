...
import com.plug.world.item.GameItem;
...
public class ClickingButtons implements PacketType {
    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        ...
        if (c.isDead)
            return;
        if (c.rights.getRightsAsInteger() >= PlayerRights.ADMINISTRATOR.getRightsAsInteger())
        ...
        switch (actionButtonId) {
            ...
            /** Specials * */
            case 29188:
                c.specBarId = 7636; // the special attack text - sendframe126(S
                // P E
            ...
            case 25120:
                ...
                Player o1 = Game.playerHandler.players[c.duelingWith];
                if (o1 == null) {
                    c.getTradeAndDuel().declineDuel();
                    return;
                }
            ...
            case 50056:
                ...
                c.getPA().startTeleport(Constants.EDGEVILLE_X, Constants.EDGEVILLE_Y, 0, type);
                break;
            ...
            case 13092:
                ...
                Player ot = Game.playerHandler.players[c.tradeWith];
                if (ot == null) {
            ...
            case 13218:
                ...
                Player ot1 = Game.playerHandler.players[c.tradeWith];
                if (ot1 == null) {
                    c.getTradeAndDuel().declineTrade();
                    c.sendMessage("Trade declined as the other player has disconnected.");
                    break;
            ...
            case 47130:
                c.forcedChat = "I must slay another " + c.taskAmount + " " + Game.npcHandler.getNpcListName(c.slayerTask) + ".";
