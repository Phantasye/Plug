...
public class CombatAssistant {
    ...
    public CombatAssistant(Player c) {
        this.c = c;
    }
    ...
    public boolean goodSlayer(int i) {
        for (int j = 0; j < slayerReqs.length; j++) {
            if (slayerReqs[j][0] == Game.npcHandler.npcs[i].npcType) {
    ...
    public void attackNpc(int i) {
        if (Game.npcHandler.npcs[i] != null) {
            if (Game.npcHandler.npcs[i].isDead || Game.npcHandler.npcs[i].MaxHP <= 0) {
                c.usingMagic = false;
                c.faceEntity(0);
                c.npcIndex = 0;
                return;
            ...
            if (Game.npcHandler.npcs[i].underAttackBy > 0 && Game.npcHandler.npcs[i].underAttackBy != c.slot && !Game.npcHandler.npcs[i].inMulti()) {
                c.npcIndex = 0;
            ...
            if (Game.npcHandler.npcs[i].spawnedBy != c.slot && Game.npcHandler.npcs[i].spawnedBy > 0) {
                resetPlayerAttack();
            ...
            if (c.attackTimer <= 0) {
                ...
                if ((!c.goodDistance(c.getX(), c.getY(), Game.npcHandler.npcs[i].getX(), Game.npcHandler.npcs[i].getY(), 2) && (usingHally() && !usingOtherRangeWeapons && !usingBow && !c.usingMagic)) || (!c.goodDistance(c.getX(), c.getY(), Game.npcHandler.npcs[i].getX(), Game.npcHandler.npcs[i].getY(), 4) && (usingOtherRangeWeapons && !usingBow && !c.usingMagic)) || (!c.goodDistance(c.getX(), c.getY(), Game.npcHandler.npcs[i].getX(), Game.npcHandler.npcs[i].getY(), 1) && (!usingOtherRangeWeapons && !usingHally() && !usingBow && !c.usingMagic)) || ((!c.goodDistance(c.getX(), c.getY(), Game.npcHandler.npcs[i].getX(), Game.npcHandler.npcs[i].getY(), 8) && (usingBow || c.usingMagic)))) {
                    c.attackTimer = 2;
                    return;
                }
                ...
                if (correctBowAndArrows() < c.playerEquipment[c.playerArrows] && Constants.CORRECT_ARROWS && usingBow && !usingCrystalBow() && c.playerEquipment[c.playerWeapon] != 9185) {
                ...
                if (usingBow || c.usingMagic || usingOtherRangeWeapons || (c.goodDistance(c.getX(), c.getY(), Game.npcHandler.npcs[i].getX(), Game.npcHandler.npcs[i].getY(), 2) && usingHally())) {
                    c.stopMovement();
                }
                ...
                // c.specAccuracy = 1.0;
                // c.specDamage = 1.0;
                Game.npcHandler.npcs[i].underAttackBy = c.slot;
                Game.npcHandler.npcs[i].lastDamageTaken = System.currentTimeMillis();
                ...
                if (c.usingMagic) { // magic hit delay
                    int pX = c.getX();
                    int pY = c.getY();
                    int nX = Game.npcHandler.npcs[i].getX();
                    int nY = Game.npcHandler.npcs[i].getY();
                    int offX = (pY - nY) * -1;
                    int offY = (pX - nX) * -1;
                    c.castingMagic = true;
                    c.projectileStage = 2;
                        ...
                        switch (c.playerEquipment[c.playerWeapon]) {
                            ...
                            case 4223: // 1/10 bow
                                ...
                                if (!c.getItems().addItem(4207, 1)) {
                                    Game.itemHandler.createGroundItem(c, 4207, c.getX(), c.getY(), 1, c.getId());
                                }
    ...
    public void delayedHit(int i) { // npc hit delay
        if (Game.npcHandler.npcs[i] != null) {
            if (Game.npcHandler.npcs[i].isDead) {
                c.npcIndex = 0;
                return;
            }
            Game.npcHandler.npcs[i].facePlayer(c.slot);

            if (Game.npcHandler.npcs[i].underAttackBy > 0 && Game.npcHandler.getsPulled(i)) {
                Game.npcHandler.npcs[i].killerId = c.slot;
            } else if (Game.npcHandler.npcs[i].underAttackBy < 0 && !Game.npcHandler.getsPulled(i)) {
                Game.npcHandler.npcs[i].killerId = c.slot;
            }
            c.lastNpcAttacked = i;
            ...
            if (!c.castingMagic && c.projectileStage > 0) { // range hit damage
                ...
                if (Misc.random(5) == 1 && c.lastArrowUsed == 9243) {
                    ignoreDef = true;
                    Game.npcHandler.npcs[i].gfx0(758);
                }

                if (Misc.random(Game.npcHandler.npcs[i].defence) > Misc.random(10 + calculateRangeAttack()) && !ignoreDef) {
                    damage = 0;
                } else if (Game.npcHandler.npcs[i].npcType == 2881 || Game.npcHandler.npcs[i].npcType == 2883 && !ignoreDef) {
                    damage = 0;
                }

                if (Misc.random(4) == 1 && c.lastArrowUsed == 9242 && damage > 0) {
                    Game.npcHandler.npcs[i].gfx0(754);
                    damage = Game.npcHandler.npcs[i].HP / 5;
                    c.dealHit(new Hit((c.playerLevel[3] / 10)));
                    c.gfx0(754);
                }

                if (c.lastWeaponUsed == 11235 || c.bowSpecShot == 1) {
                    if (Misc.random(Game.npcHandler.npcs[i].defence) > Misc.random(10 + calculateRangeAttack()))
                        damage2 = 0;
                }
                if (c.dbowSpec) {
                    Game.npcHandler.npcs[i].gfx100(1100);
                    if (damage < 8)
                        damage = 8;
                    if (damage2 < 8)
                        damage2 = 8;
                ...
                if (damage > 0 && Misc.random(5) == 1 && c.lastArrowUsed == 9244) {
                    damage *= 1.45;
                    Game.npcHandler.npcs[i].gfx0(756);
                }

                if (Game.npcHandler.npcs[i].HP - damage < 0) {
                    damage = Game.npcHandler.npcs[i].HP;
                }
                if (Game.npcHandler.npcs[i].HP - damage <= 0 && damage2 > 0) {
                    damage2 = 0;
                }
                if (c.fightMode == 3) {
                ...
                if (damage > 0) {
                    if (Game.npcHandler.npcs[i].npcType >= 3777 && Game.npcHandler.npcs[i].npcType <= 3780) {
                        c.pcDamage += damage;
                    }
                }
                ...
                Game.npcHandler.npcs[i].underAttack = true;
                Game.npcHandler.npcs[i].dealHit(new Hit(damage, HitType.NORMAL));
                if (damage2 > -1) {
                    Game.npcHandler.npcs[i].dealSecondaryHit(new Hit(damage2, HitType.NORMAL));
                ...
                if (Misc.random(Game.npcHandler.npcs[i].defence) > 10 + Misc.random(mageAtk()) + bonusAttack) {
                    damage = 0;
                    magicFailed = true;
                } else if (Game.npcHandler.npcs[i].npcType == 2881 || Game.npcHandler.npcs[i].npcType == 2882) {
                    damage = 0;
                    magicFailed = true;
                }
                ...
                if (getEndGfxHeight() == 100 && !magicFailed) { // end GFX
                    Game.npcHandler.npcs[i].gfx100(c.MAGIC_SPELLS[c.oldSpellId][5]);
                } else if (!magicFailed) {
                    Game.npcHandler.npcs[i].gfx0(c.MAGIC_SPELLS[c.oldSpellId][5]);
                }

                if (magicFailed) {
                    Game.npcHandler.npcs[i].gfx100(85);
                }
                if (!magicFailed) {
                    int freezeDelay = getFreezeTime();// freeze
                    if (freezeDelay > 0 && Game.npcHandler.npcs[i].freezeTimer == 0) {
                        Game.npcHandler.npcs[i].freezeTimer = freezeDelay;
                    }
    ...
    public void applyNpcMeleeDamage(int i, int damageMask) {
        ...
        if (!fullVeracsEffect) {
            if (Misc.random(Game.npcHandler.npcs[i].defence) > 10 + Misc.random(calculateMeleeAttack())) {
                damage = 0;
            } else if (Game.npcHandler.npcs[i].npcType == 2882 || Game.npcHandler.npcs[i].npcType == 2883) {
                damage = 0;
            }
        }
        ...
        if (damage > 0 && guthansEffect) {
            ...
            c.getPA().refreshSkill(3);
            Game.npcHandler.npcs[i].gfx0(398);
        }
        Game.npcHandler.npcs[i].underAttack = true;
        ...
        switch (damageMask) {
            ...
            case 2:
                Game.npcHandler.npcs[i].dealSecondaryHit(new Hit(damage, HitType.NORMAL));
                c.totalDamageDealt += damage;
                c.doubleHit = false;
                break;
    ...
    public void fireProjectileNpc() {
        if (c.oldNpcIndex > 0) {
            if (Game.npcHandler.npcs[c.oldNpcIndex] != null) {
                c.projectileStage = 2;
                int pX = c.getX();
                int pY = c.getY();
                int nX = Game.npcHandler.npcs[c.oldNpcIndex].getX();
                int nY = Game.npcHandler.npcs[c.oldNpcIndex].getY();
                int offX = (pY - nY) * -1;
                int offY = (pX - nX) * -1;
    ...
    public void attackPlayer(int i) {
        ...
        if (Game.playerHandler.players[i] != null) {

            if (Game.playerHandler.players[i].isDead) {
                resetPlayerAttack();
                return;
            }

            if (c.respawnTimer > 0 || Game.playerHandler.players[i].respawnTimer > 0) {
                resetPlayerAttack();
                return;
            }
            ...
            boolean sameSpot = c.absX == Game.playerHandler.players[i].getX() && c.absY == Game.playerHandler.players[i].getY();
            if (!c.goodDistance(Game.playerHandler.players[i].getX(), Game.playerHandler.players[i].getY(), c.getX(), c.getY(), 25) && !sameSpot) {
                resetPlayerAttack();
                return;
            }

            if (Game.playerHandler.players[i].respawnTimer > 0) {
                Game.playerHandler.players[i].playerIndex = 0;
                resetPlayerAttack();
                return;
            }

            if (Game.playerHandler.players[i].heightLevel != c.heightLevel) {
                resetPlayerAttack();
                return;
            }
            ...
            if (c.attackTimer <= 0) {
                ...
                if (c.absX == Game.playerHandler.players[i].absX && c.absY == Game.playerHandler.players[i].absY) {
                    if (c.freezeTimer > 0) {
                        resetPlayerAttack();
                        return;
                    }
                ...
                if ((!c.goodDistance(c.getX(), c.getY(), Game.playerHandler.players[i].getX(), Game.playerHandler.players[i].getY(), 4) && (usingOtherRangeWeapons && !usingBow && !c.usingMagic)) || (!c.goodDistance(c.getX(), c.getY(), Game.playerHandler.players[i].getX(), Game.playerHandler.players[i].getY(), 2) && (!usingOtherRangeWeapons && usingHally() && !usingBow && !c.usingMagic)) || (!c.goodDistance(c.getX(), c.getY(), Game.playerHandler.players[i].getX(), Game.playerHandler.players[i].getY(), getRequiredDistance()) && (!usingOtherRangeWeapons && !usingHally() && !usingBow && !c.usingMagic)) || (!c.goodDistance(c.getX(), c.getY(), Game.playerHandler.players[i].getX(), Game.playerHandler.players[i].getY(), 10) && (usingBow || c.usingMagic))) {
                ...
                if (correctBowAndArrows() < c.playerEquipment[c.playerArrows] && Constants.CORRECT_ARROWS && usingBow && !usingCrystalBow() && c.playerEquipment[c.playerWeapon] != 9185 && !c.usingMagic) {
                    c.sendMessage("You can't use " + c.getItems().getItemName(c.playerEquipment[c.playerArrows]).toLowerCase() + "s with a " + c.getItems().getItemName(c.playerEquipment[c.playerWeapon]).toLowerCase() + ".");
                    c.stopMovement();
                    resetPlayerAttack();
                    return;
                ...
                c.faceEntity(i + 32768);

                if (c.duelStatus != 5) {
                    if (!c.attackedPlayers.contains(c.playerIndex) && !Game.playerHandler.players[c.playerIndex].attackedPlayers.contains(c.slot)) {
                ...
                Game.playerHandler.players[i].underAttackBy = c.slot;
                Game.playerHandler.players[i].logoutDelay = System.currentTimeMillis();
                Game.playerHandler.players[i].singleCombatDelay = System.currentTimeMillis();
                Game.playerHandler.players[i].killerId = c.slot;
                c.lastArrowUsed = 0;
                c.rangeItemUsed = 0;
                if (!usingBow && !c.usingMagic && !usingOtherRangeWeapons) { // melee
                    // hit
                    // delay
                    c.followId = Game.playerHandler.players[c.playerIndex].slot;
                ...
                if (c.usingMagic) { // magic hit delay
                    int pX = c.getX();
                    int pY = c.getY();
                    int nX = Game.playerHandler.players[i].getX();
                    int nY = Game.playerHandler.players[i].getY();
                    int offX = (pY - nY) * -1;
                    int offY = (pX - nX) * -1;
                    c.castingMagic = true;
                    c.projectileStage = 2;
                    ...
                    c.oldSpellId = c.spellId;
                    c.spellId = 0;
                    Player o = Game.playerHandler.players[i];
                    ...
                    if (freezeDelay > 0 && Game.playerHandler.players[i].freezeTimer <= -3 && !c.magicFailed) {
                        Game.playerHandler.players[i].freezeTimer = freezeDelay;
                        o.resetWalkingQueue();
    ...
    public void appendVengeance(int otherPlayer, int damage) {
        if (damage <= 0)
            return;
        Player o = Game.playerHandler.players[otherPlayer];
        ...
        if ((o.playerLevel[3] - damage) > 0) {
            ...
            c.dealSecondaryHit(new Hit(damage));
        }
    }

    public void playerDelayedHit(int i) {
        if (Game.playerHandler.players[i] != null) {
            if (Game.playerHandler.players[i].isDead || c.isDead || Game.playerHandler.players[i].playerLevel[3] <= 0 || c.playerLevel[3] <= 0) {
                c.playerIndex = 0;
                return;
            }
            if (Game.playerHandler.players[i].respawnTimer > 0) {
            ...
            if (!c.castingMagic && c.projectileStage > 0) { // range hit damage
                ...
                if (Misc.random(4) == 1 && c.lastArrowUsed == 9242 && damage > 0) {
                    Game.playerHandler.players[i].gfx0(754);
                    damage = Game.npcHandler.npcs[i].HP / 5;
                    c.dealHit(new Hit(c.playerLevel[3] / 10));
                    c.gfx0(754);
                }
                ...
                if (Game.playerHandler.players[i].playerLevel[3] - damage < 0) {
                    damage = Game.playerHandler.players[i].playerLevel[3];
                }
                if (Game.playerHandler.players[i].playerLevel[3] - damage - damage2 < 0) {
                    damage2 = Game.playerHandler.players[i].playerLevel[3] - damage;
                }
                if (damage < 0)
                    damage = 0;
                ...
                Game.playerHandler.players[i].damageTaken[c.slot] += damage;
                c.killedBy = Game.playerHandler.players[i].slot;
                // Server.playerHandler.players[i].handleHitMask(damage);
                Game.playerHandler.players[i].dealHit(new Hit(damage));
                if (damage2 != -1) {
                    // Server.playerHandler.players[i].playerLevel[3] -=
                    // damage2;
                    Game.playerHandler.players[i].dealSecondaryHit(new Hit(damage2));
                    Game.playerHandler.players[i].damageTaken[c.slot] += damage2;

                }
                o.getPA().refreshSkill(3);

                // Server.playerHandler.players[i].setHitUpdateRequired(true);
                Game.playerHandler.players[i].updateRequired = true;
                applySmite(i, damage);
                if (damage2 != -1)
                ...
                if (getEndGfxHeight() == 100 && !c.magicFailed) { // end GFX
                    Game.playerHandler.players[i].gfx100(c.MAGIC_SPELLS[c.oldSpellId][5]);
                } else if (!c.magicFailed) {
                    Game.playerHandler.players[i].gfx0(c.MAGIC_SPELLS[c.oldSpellId][5]);
                } else if (c.magicFailed) {
                    Game.playerHandler.players[i].gfx100(85);
                }

                if (!c.magicFailed) {
                    if (System.currentTimeMillis() - Game.playerHandler.players[i].reduceStat > 35000) {
                        Game.playerHandler.players[i].reduceStat = System.currentTimeMillis();
                        switch (c.MAGIC_SPELLS[c.oldSpellId][0]) {
                            case 12987:
                            case 13011:
                            case 12999:
                            case 13023:
                                Game.playerHandler.players[i].playerLevel[0] -= ((o.getPA().getLevelForXP(Game.playerHandler.players[i].playerXP[0]) * 10) / 100);
                                break;
                        }
                    }
                    ...
                    switch (c.MAGIC_SPELLS[c.oldSpellId][0]) {
                        ...
                        case 1153:
                            Game.playerHandler.players[i].playerLevel[0] -= ((o.getPA().getLevelForXP(Game.playerHandler.players[i].playerXP[0]) * 5) / 100);
                            o.sendMessage("Your attack level has been reduced!");
                            Game.playerHandler.players[i].reduceSpellDelay[c.reduceSpellId] = System.currentTimeMillis();
                            o.getPA().refreshSkill(0);
                            break;

                        case 1157:
                            Game.playerHandler.players[i].playerLevel[2] -= ((o.getPA().getLevelForXP(Game.playerHandler.players[i].playerXP[2]) * 5) / 100);
                        ...
                        case 1161:
                            Game.playerHandler.players[i].playerLevel[1] -= ((o.getPA().getLevelForXP(Game.playerHandler.players[i].playerXP[1]) * 5) / 100);
                        ...
                        case 1542:
                            Game.playerHandler.players[i].playerLevel[1] -= ((o.getPA().getLevelForXP(Game.playerHandler.players[i].playerXP[1]) * 10) / 100);
                            o.sendMessage("Your defence level has been reduced!");
                            Game.playerHandler.players[i].reduceSpellDelay[c.reduceSpellId] = System.currentTimeMillis();
                            o.getPA().refreshSkill(1);
                            break;
                        ...
                        case 1543:
                            Game.playerHandler.players[i].playerLevel[2] -= ((o.getPA().getLevelForXP(Game.playerHandler.players[i].playerXP[2]) * 10) / 100);
                            o.sendMessage("Your strength level has been reduced!");
                            Game.playerHandler.players[i].reduceSpellDelay[c.reduceSpellId] = System.currentTimeMillis();
                            o.getPA().refreshSkill(2);
                            break;
                ...
                if (o.inMulti() && multis()) {
                    ...
                    for (int j = 0; j < Game.playerHandler.players.length; j++) {
                        if (Game.playerHandler.players[j] != null) {
                            ...
                            if (c.barrageCount >= 9)
                                break;
                            if (o.goodDistance(o.getX(), o.getY(), Game.playerHandler.players[j].getX(), Game.playerHandler.players[j].getY(), 1))
    ...
    public void appendMultiBarrage(int playerId, boolean splashed) {
        if (Game.playerHandler.players[playerId] != null) {
            Player c2 = Game.playerHandler.players[playerId];
            ...
            if (checkMultiBarrageReqs(playerId)) {
                ...
                if (Misc.random(mageAtk()) > Misc.random(mageDef()) && !c.magicFailed) {
                    ...
                    Game.playerHandler.players[playerId].dealHit(new Hit(damage));
                    Game.playerHandler.players[playerId].damageTaken[c.slot] += damage;
    ...
    public void multiSpellEffect(int playerId, int damage) {
        switch (c.MAGIC_SPELLS[c.oldSpellId][0]) {
            case 13011:
            case 13023:
                if (System.currentTimeMillis() - Game.playerHandler.players[playerId].reduceStat > 35000) {
                    Game.playerHandler.players[playerId].reduceStat = System.currentTimeMillis();
                    Game.playerHandler.players[playerId].playerLevel[0] -= ((Game.playerHandler.players[playerId].getLevelForXP(Game.playerHandler.players[playerId].playerXP[0]) * 10) / 100);
                }
                break;
            case 12919: // blood spells
            case 12929:
            ...
            case 12891:
            case 12881:
                if (Game.playerHandler.players[playerId].freezeTimer < -4) {
                    Game.playerHandler.players[playerId].freezeTimer = getFreezeTime();
                    Game.playerHandler.players[playerId].stopMovement();
                }
                break;
        }
    }
    ...
    public void applyPlayerMeleeDamage(int i, int damageMask) {
        ...
        Game.playerHandler.players[i].killerId = c.slot;
        Game.playerHandler.players[i].singleCombatDelay = System.currentTimeMillis();
        if (c.killedBy != Game.playerHandler.players[i].slot)
        ...
        switch (damageMask) {
            ...
            case 2:
                 ...
                 */
                // Server.playerHandler.players[i].playerLevel[3] -= damage;
                Game.playerHandler.players[i].dealSecondaryHit(new Hit(damage));
                Game.playerHandler.players[i].damageTaken[c.slot] += damage;
                c.totalPlayerDamageDealt += damage;
                c.doubleHit = false;
                break;
    ...
    public void applySmite(int index, int damage) {
        ...
        if (damage <= 0)
            return;
        if (Game.playerHandler.players[index] != null) {
            Player c2 = Game.playerHandler.players[index];
    ...
    public void fireProjectilePlayer() {
        if (c.oldPlayerIndex > 0) {
            if (Game.playerHandler.players[c.oldPlayerIndex] != null) {
                c.projectileStage = 2;
                int pX = c.getX();
                int pY = c.getY();
                int oX = Game.playerHandler.players[c.oldPlayerIndex].getX();
                int oY = Game.playerHandler.players[c.oldPlayerIndex].getY();
                int offX = (pY - oY) * -1;
                int offY = (pX - oX) * -1;
                if (!c.msbSpec)
    ...
    public void activateSpecial(int weapon, int i) {
        if (Game.npcHandler.npcs[i] == null && c.npcIndex > 0) {
            return;
        }
        if (Game.playerHandler.players[i] == null && c.playerIndex > 0) {
            return;
        }
        c.doubleHit = false;
        c.specEffect = 0;
        ...
        switch (weapon) {
            ...
            case 4151: // whip
                if (Game.npcHandler.npcs[i] != null) {
                    Game.npcHandler.npcs[i].gfx100(341);
                }
                c.specAccuracy = 1.10;
            ...
            case 3204: // d hally
                ...
                c.hitDelay = getHitDelay(c.getItems().getItemName(c.playerEquipment[c.playerWeapon]).toLowerCase());
                if (Game.npcHandler.npcs[i] != null && c.npcIndex > 0) {
                    if (!c.goodDistance(c.getX(), c.getY(), Game.npcHandler.npcs[i].getX(), Game.npcHandler.npcs[i].getY(), 1)) {
                        c.doubleHit = true;
                    }
                }
                if (Game.playerHandler.players[i] != null && c.playerIndex > 0) {
                    if (!c.goodDistance(c.getX(), c.getY(), Game.playerHandler.players[i].getX(), Game.playerHandler.players[i].getY(), 1)) {
                        c.doubleHit = true;
    ...
    public int getKillerId(int playerId) {
        ...
        for (int i = 1; i < Constants.MAX_PLAYERS; i++) {
            if (Game.playerHandler.players[i] != null) {
                if (Game.playerHandler.players[i].killedBy == playerId) {
                    if (Game.playerHandler.players[i].withinDistance(Game.playerHandler.players[playerId])) {
                        if (Game.playerHandler.players[i].totalPlayerDamageDealt > oldDamage) {
                            oldDamage = Game.playerHandler.players[i].totalPlayerDamageDealt;
                            killerId = i;
                        }
                    }
                    Game.playerHandler.players[i].totalPlayerDamageDealt = 0;
                    Game.playerHandler.players[i].killedBy = 0;
                }
            }
        }
        return killerId;
    ...
    public boolean checkReqs() {
        ...
        if (c.playerIndex == c.slot)
            return false;
        if (c.inPits && Game.playerHandler.players[c.playerIndex].inPits)
            return true;
        if (Game.playerHandler.players[c.playerIndex].inDuelArena() && c.duelStatus != 5 && !c.usingMagic) {
        ...
        if (c.duelStatus == 5 && Game.playerHandler.players[c.playerIndex].duelStatus == 5) {
            if (Game.playerHandler.players[c.playerIndex].duelingWith == c.getId()) {
                return true;
            } else {
        ...
        if (!Game.playerHandler.players[c.playerIndex].inWild()) {
        ...
        if (Constants.COMBAT_LEVEL_DIFFERENCE) {
            int combatDif1 = c.getCombat().getCombatDifference(c.combatLevel, Game.playerHandler.players[c.playerIndex].combatLevel);
            if (combatDif1 > c.wildLevel || combatDif1 > Game.playerHandler.players[c.playerIndex].wildLevel) {
        ...
        if (Constants.SINGLE_AND_MULTI_ZONES) {
            if (!Game.playerHandler.players[c.playerIndex].inMulti()) { // single
                // combat
                // zones
                if (Game.playerHandler.players[c.playerIndex].underAttackBy != c.slot && Game.playerHandler.players[c.playerIndex].underAttackBy != 0) {
                    c.sendMessage("That player is already in combat.");
                    c.stopMovement();
                    c.getCombat().resetPlayerAttack();
                    return false;
                }
                if (Game.playerHandler.players[c.playerIndex].slot != c.underAttackBy && c.underAttackBy != 0 || c.underAttackBy2 > 0) {
    ...
    public boolean checkMultiBarrageReqs(int i) {
        ...
        if (i == c.slot)
            return false;
        if (c.inPits && Game.playerHandler.players[i].inPits)
            return true;
        if (!Game.playerHandler.players[i].inWild()) {
            return false;
        }
        if (Constants.COMBAT_LEVEL_DIFFERENCE) {
            int combatDif1 = c.getCombat().getCombatDifference(c.combatLevel, Game.playerHandler.players[i].combatLevel);
            if (combatDif1 > c.wildLevel || combatDif1 > Game.playerHandler.players[i].wildLevel) {
                c.sendMessage("Your combat level difference is too great to attack that player here.");
                return false;
            }
        }
        ...
        if (Constants.SINGLE_AND_MULTI_ZONES) {
            if (!Game.playerHandler.players[i].inMulti()) { // single combat
                // zones
                if (Game.playerHandler.players[i].underAttackBy != c.slot && Game.playerHandler.players[i].underAttackBy != 0) {
                    return false;
                }
                if (Game.playerHandler.players[i].slot != c.underAttackBy && c.underAttackBy != 0) {
                    c.sendMessage("You are already in combat.");
                    return false;
                }
            }
     ...
     * 4219) {//Cbow 5/10 rangehit = 4; rangehit += c.playerLevel[4] / 6; } else
     * if (weapon == 4218) {//Cbow 6/10 rangehit = 5; rangehit +=
     ...
     * 4215) {//Cbow 9/10 rangehit = 6; rangehit += c.playerLevel[4] / 5; } else
     * if (weapon == 4214) {//Cbow Full rangehit = 7; rangehit +=
     * c.playerLevel[4] / 5; } else if (weapon == 6522) { rangehit = 5; rangehit +=
     * c.playerLevel[4] / 6; } else if (weapon == 9029) {//dragon darts rangehit =
     * 8; rangehit += c.playerLevel[4] / 10; } else if (weapon == 811 || weapon ==
     * 868) {//rune darts rangehit = 2; rangehit += c.playerLevel[4] / 8.5; }
     * else if (weapon == 810 || weapon == 867) {//adamant darts rangehit = 2;
     * rangehit += c.playerLevel[4] / 9; } else if (weapon == 809 || weapon ==
     * 866) {//mithril darts rangehit = 2; rangehit += c.playerLevel[4] / 9.5; }
     * else if (weapon == 808 || weapon == 865) {//Steel darts rangehit = 2;
     * rangehit += c.playerLevel[4] / 10; } else if (weapon == 807 || weapon ==
     * 863) {//Iron darts rangehit = 2; rangehit += c.playerLevel[4] / 10.5; }
     * else if (weapon == 806 || weapon == 864) {//Bronze darts rangehit = 1;
     * rangehit += c.playerLevel[4] / 11; } else if (Arrows == 4740 && weapon ==
     * 4734) {//BoltRacks rangehit = 3; rangehit += c.playerLevel[4] / 6; } else
     * if (Arrows == 11212) {//dragon arrows rangehit = 4; rangehit +=
     * c.playerLevel[4] / 5.5; } else if (Arrows == 892) {//rune arrows rangehit =
     * 3; rangehit += c.playerLevel[4] / 6; } else if (Arrows == 890) {//adamant
     * arrows rangehit = 2; rangehit += c.playerLevel[4] / 7; } else if (Arrows ==
     * 888) {//mithril arrows rangehit = 2; rangehit += c.playerLevel[4] / 7.5; }
     * else if (Arrows == 886) {//steel arrows rangehit = 2; rangehit +=
     * c.playerLevel[4] / 8; } else if (Arrows == 884) {//Iron arrows rangehit =
     * 2; rangehit += c.playerLevel[4] / 9; } else if (Arrows == 882) {//Bronze
     * arrows rangehit = 1; rangehit += c.playerLevel[4] / 9.5; } else if
     * (Arrows == 9244) { rangehit = 8; rangehit += c.playerLevel[4] / 3; } else
     * if (Arrows == 9139) { rangehit = 12; rangehit += c.playerLevel[4] / 4; }
     * else if (Arrows == 9140) { rangehit = 2; rangehit += c.playerLevel[4] /
     * 7; } else if (Arrows == 9141) { rangehit = 3; rangehit +=
     * c.playerLevel[4] / 6; } else if (Arrows == 9142) { rangehit = 4; rangehit +=
     * c.playerLevel[4] / 6; } else if (Arrows == 9143) { rangehit = 7; rangehit +=
     * c.playerLevel[4] / 5; } else if (Arrows == 9144) { rangehit = 7; rangehit +=
     * c.playerLevel[4] / 4.5; } int bonus = 0; bonus -= rangehit / 10; rangehit +=
     * bonus; if (c.specDamage != 1) rangehit *= c.specDamage; if (rangehit ==
     * 0) rangehit++; if (c.fullVoidRange()) { rangehit *= 1.10; } if
     * (c.prayerActive[3]) rangehit *= 1.05; else if (c.prayerActive[11])
        ...
        if (c.usingMagic && c.playerIndex > 0) {
            if (Game.playerHandler.players[c.playerIndex] != null) {
                for (int r = 0; r < c.REDUCE_SPELLS.length; r++) { // reducing
                    ...
                    // confuse
                    // etc
                    if (Game.playerHandler.players[c.playerIndex].REDUCE_SPELLS[r] == c.MAGIC_SPELLS[spell][0]) {
                        c.reduceSpellId = r;
                        if ((System.currentTimeMillis() - Game.playerHandler.players[c.playerIndex].reduceSpellDelay[c.reduceSpellId]) > Game.playerHandler.players[c.playerIndex].REDUCE_SPELL_TIME[c.reduceSpellId]) {
                            Game.playerHandler.players[c.playerIndex].canUseReducingSpell[c.reduceSpellId] = true;
                        } else {
                            Game.playerHandler.players[c.playerIndex].canUseReducingSpell[c.reduceSpellId] = false;
                        }
                        break;
                    }
                }
                if (!Game.playerHandler.players[c.playerIndex].canUseReducingSpell[c.reduceSpellId]) {
    ...
    public void handleDfs() {
        if (System.currentTimeMillis() - c.dfsDelay > 30000) {
            if (c.playerIndex > 0 && Game.playerHandler.players[c.playerIndex] != null) {
                int damage = Misc.random(15) + 5;
                c.startAnimation(2836);
                c.gfx0(600);
                Game.playerHandler.players[c.playerIndex].dealSecondaryHit(new Hit(damage));
    ...
    public void handleDfsNPC() {
        if (System.currentTimeMillis() - c.dfsDelay > 30000) {
            if (c.npcIndex > 0 && Game.npcHandler.npcs[c.npcIndex] != null) {
                int damage = Misc.random(15) + 5;
                c.startAnimation(2836);
                c.gfx0(600);
                Game.npcHandler.npcs[c.npcIndex].dealSecondaryHit(new Hit(damage, HitType.NORMAL));
                c.dfsDelay = System.currentTimeMillis();
            } else {
                c.sendMessage("I should be in combat before using this.");
            }
    ...
    public void applyRecoil(int damage, int i) {
        if (damage > 0 && Game.playerHandler.players[i].playerEquipment[c.playerRing] == 2550) {
            int recDamage = damage / 10 + 1;
            if (!c.hitUpdateRequired) {
                c.dealHit(new Hit(recDamage, HitType.DIESEASE));
            } else if (!c.secondaryHitUpdateRequired) {
    ...
    public int getBonusAttack(int i) {
        switch (Game.npcHandler.npcs[i].npcType) {
            case 2883:
    ...
    public void handleGmaulPlayer() {
        if (c.playerIndex > 0) {
            Player o = Game.playerHandler.players[c.playerIndex];
